...
2. Ask who said what about a specific topic to jump straight to the relevant moment, instead of scrubbing the recording.
3. If you missed several related meetings, ask Copilot Chat to summarize across all of them and pull out the key issues and proposed solutions.

**Prompts**
```
Summarize this meeting's key decisions, action items, and open questions.
```
```
What did Priya say about the timeline?
```
```
Summarize the marketing team meeting I missed and identify the key issues
