...
**What you'll use**
- [[Meeting Recap and Intelligent Recap]] — captures notes and action items from the meeting itself
- [[Create Tasks From Notes]] — turns those action items into trackable tasks
- [[Draft with Copilot in Word]] with [[Ground a Draft on Your Files]] — writes the brief from the notes
...
## Related
[[Word]] · [[Teams]] · [[OneNote & Loop]] · [[Build a Copilot Notebook for a Recurring Project Status]]
