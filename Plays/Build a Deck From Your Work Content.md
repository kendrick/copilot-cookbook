...
**What you'll use**
- [[Ground a Deck in Your Work Content]] — points Copilot at the specific files it should build from
- [[Build a Presentation With Copilot]] — drafts the outline and slides
- [[Generate Images in PowerPoint]] — custom visuals where a stock image won't cut it
- [[Rewrite and Summarize Slides]] — a tightening pass once the structure holds
...
## Related
[[PowerPoint]] · [[Create]] · [[Turn a Report Into a Deck]]
