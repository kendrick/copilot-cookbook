...
2. Summarize it to see what's resolved and what isn't.
3. Ask Copilot to draft a reply based on the summary and what you actually want to say.
4. Adjust tone and length before sending.

**Prompts**
```
Summarize this thread and tell me what's still unresolved.
```
```
Draft a reply that agrees to the extension but flags the budget concern.
