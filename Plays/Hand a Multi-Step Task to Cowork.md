...
**What you'll use**
- [[Copilot Cowork]] — the agentic executor that works through the steps with approval at each one
- [[Scheduled Prompts and Long-Running Tasks]] — for turning a one-off Cowork task into a recurring one
...
## Related
[[Cowork]] · [[Copilot Chat]] · [[Schedule a Recurring Status Digest]]
